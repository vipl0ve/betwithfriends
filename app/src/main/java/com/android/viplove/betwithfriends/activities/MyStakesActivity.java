...
public class MyStakesActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_stakes);
    ...
    public void fillTheStakeList() {

        //ArrayAdapter adapter = new ArrayAdapter(getApplicationContext(), R.layout.odds_list_item, R.id.odds_tv, allEventOdds);
        //ListView eventListView = (ListView) findViewById(R.id.allStakesListView);
