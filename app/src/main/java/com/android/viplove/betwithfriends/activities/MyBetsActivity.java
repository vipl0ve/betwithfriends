...
public class MyBetsActivity extends AppCompatActivity
    ...
    public void fillTheBetList() {

        BetRepo dbHandler = new BetRepo(this, null, null, 1);

        ArrayList allEventCollection = dbHandler.getAllBetName();

        ArrayAdapter adapter = new ArrayAdapter(getApplicationContext(), R.layout.odds_list_item, R.id.odds_tv, allEventCollection);
        ListView eventListView = (ListView) findViewById(R.id.allBetsListView);
